    ...
    <div className="section-nav">
      ...
      {openDropdown === 2 && (
        <ul className="dropdown-menu">
          ...
          >
            2. Performance and Application Test Requirements
          </button>
          <button
            className={
          ...
          >
            3. Observation on Visual /Aesthetic Requirements Checks - Manual Entry
          </button>
          <button
            className={
          ...
          >
            4. General / Standard Requirements
          </button>
          <button
            className={
          ...
          >
            5. General / Stickers / Caution / Attention Requirements
          </button>
          <button
            className={
