...
export default function Section2() {
  ...
  const onSubmit = async (data) => {
    ...
    takeSectionScreenShot("section2-form-4", false);
  };
  ...
  return (
    <div className="form-section" id="section2-form">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-section-info" id="section2-form-1">
        ...
        <div className="form-section-info" id="section2-form-2">
        ...
        <div className="form-section-info" id="section2-form-3">
          <div className="form-row">
            <div className="user-input">
              <label htmlFor="" className="field-label check-label">
                Bottom Side
        ...
        <div className="form-section-info" id="section2-form-4">
          <div className="form-row">
            <div className="user-input">
              <label htmlFor="" className="field-label radio-label">
