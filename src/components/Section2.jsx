...
import { Section2DataStore } from "@/store/FormData";
...
export default function Section2() {
  ...
  const onSubmit = async (data) => {
    ...
    link.download = `${testId ? testId : "default"}-section2-form-1.png`;
    ...
    takeSectionScreenshot("section2-form-2", true);
    takeSectionScreenshot("section2-form-3", true);
    takeSectionScreenshot("section2-form-4", true);
    takeSectionScreenshot("section2-form-5", true);
    takeSectionScreenshot("section2-form-6", true);
    takeSectionScreenshot("section2-form-7", false);
    ...
    <div className="form-section" id="section2-form">
      <form onSubmit={handleSubmit(onSubmit)}>
        <table className="toggle-table">
          <tbody>
            <div className="table-row-info" id="section2-form-1">
            ...
            <div className="table-row-info" id="section2-form-2">
              <tr>
                <td className="user-input user-toggle">
            ...
            <div className="table-row-info" id="section2-form-3">
              <tr className="section-title">
            ...
            <div className="table-row-info" id="section2-form-4">
              <tr className="section-title">
            ...
            <div className="table-row-info" id="section2-form-5">
              <tr>
                <td className="user-input user-toggle">
            ...
            <div className="table-row-info" id="section2-form-6">
              <tr className="section-title">
            ...
            <div className="table-row-info" id="section2-form-6">
              <tr className="section-title">
                <td className="user-toggle user-input">MPR</td>
              </tr>
              <tr>
                <td className="user-input user-toggle">
                  <label htmlFor="toggle-15-a" className="field-label">
                    Pulse the motor and trip (MPR) emergency push button 5 times and reset. No ay abnormalities should occur
                  </label>
                </td>
                <td className="toggle-container">
                  <input
                    ...
                    className="toggle-input"
                  />
                  <label htmlFor="toggle-15-a" className="toggle-label">
                    <span className="toggle-switch"></span>
                    <span className="toggle-text on">Yes</span>
                    <span className="toggle-text off">No</span>
                  </label>
            ...
            <div className="table-row-info" id="section2-form-7">
              <tr className="section-title">
